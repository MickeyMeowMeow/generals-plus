...
export const SystemSettingsSchema = z.object({
  allowMapCreation: z.boolean().describe("是否允许非管理员创建地图"),
  allowMapUpdates: z.boolean().describe("是否允许非管理员更新地图"),
  systemBanner: z.string().describe("面向所有用户展示的系统横幅消息"),
  ...
  maintenanceMode: z.boolean().describe("系统是否处于维护模式"),
});
